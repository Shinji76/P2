...
void JsonVisitor::visit(const Mostro& mostro) {
    ...
    mostro_object.insert("Rarita", QJsonValue::fromVariant(mostro.getRarita()));
    mostro_object.insert("Classe", QJsonValue::fromVariant(mostro.getClasse()));
    mostro_object.insert("Path", QJsonValue::fromVariant(mostro.getPath().c_str()));
    mostro_object.insert("Razza", QJsonValue::fromVariant(mostro.getRazza()));
...
void JsonVisitor::visit(const Magia& magia) {
    ...
    magia_object.insert("Rarita", QJsonValue::fromVariant(magia.getRarita()));
    magia_object.insert("Classe", QJsonValue::fromVariant(magia.getClasse()));
    magia_object.insert("Path", QJsonValue::fromVariant(magia.getPath().c_str()));
...
void JsonVisitor::visit(const Segreto& segreto) {
    ...
    segreto_object.insert("Rarita", QJsonValue::fromVariant(segreto.getRarita()));
    segreto_object.insert("Classe", QJsonValue::fromVariant(segreto.getClasse()));
    segreto_object.insert("Path", QJsonValue::fromVariant(segreto.getPath().c_str()));
